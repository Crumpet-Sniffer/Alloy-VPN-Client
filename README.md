...
I made alloy because I sometimes use linux on my laptop, and I use 3 VPNs depending on what I need doing, but it's often hard to keep track of which one I'm using and turning on/off
each one, especially as 2/3 of the ones I use have no linux GUI. So I made Alloy, a 100% python VPN GUI where I can manage all my VPNs in one place.
